from src.contexts.beer.beer.application.command import BEER_COMMAND_HANDLERS
from src.contexts.beer.beer.application.query import BEER_QUERY_HANDLERS
from src.contexts.beer.beer.infrastructure.persistence.sqlite import (
    SqliteBeerRepository,
)
from src.contexts.beer.store.application.command import STORE_COMMAND_HANDLERS
from src.contexts.beer.store.application.query import STORE_QUERY_HANDLERS
from src.contexts.beer.store.infrastructure.persistence.sqlite import (
    SqliteStoreRepository,
)
from src.contexts.ioc_container import IoCContainer
from src.contexts.shared.infrastructure.bus.command import InMemoryCommandBus
from src.contexts.shared.infrastructure.bus.query import InMemoryQueryBus
from src.contexts.shared.infrastructure.persistence.sqlite.db import (
    SqliteSession,
)
